			...
			<section className="max-w-5xl">
				<div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
					<div>
						...
						<div className="mt-5">
							<a href={bookingUrl} target="_blank" rel="noreferrer" className="inline-flex items-center px-5 py-3 rounded-md bg-teal-600 text-white hover:bg-teal-700 transition">
								Book a call
							</a>
						</div>
					</div>
					...
					<aside className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5 shadow-sm">
						...
						<div className="mt-4 space-y-3">
							<a href="https://github.com/azkalonz" target="_blank" rel="noreferrer" className="flex items-center justify-between rounded-lg border border-slate-200 dark:border-slate-800 px-3 py-2 text-sm text-slate-700 dark:text-slate-200 hover:border-teal-400/60 hover:text-teal-600 transition">
							...
							<a href="https://www.linkedin.com/in/markjudaya/" target="_blank" rel="noreferrer" className="flex items-center justify-between rounded-lg border border-slate-200 dark:border-slate-800 px-3 py-2 text-sm text-slate-700 dark:text-slate-200 hover:border-teal-400/60 hover:text-teal-600 transition">
								<span className="inline-flex items-center gap-2">
									<svg aria-hidden="true" viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor">
							...
							<a href="https://www.fiverr.com/markjudaya" target="_blank" rel="noreferrer" className="flex items-center justify-between rounded-lg border border-slate-200 dark:border-slate-800 px-3 py-2 text-sm text-slate-700 dark:text-slate-200 hover:border-teal-400/60 hover:text-teal-600 transition">
								<span className="inline-flex items-center gap-2">
									<svg aria-hidden="true" viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor">
